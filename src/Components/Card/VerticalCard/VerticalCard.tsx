      ...
      <View style={Style.VerticalCardWrap}>
        ...
        <View style={Style.InfoContainer}>
          ...
          <View style={Style.BadgeContainer}>
            <FastImage source={Images.FindBtnBadge} style={Style.BadgeImg} />
          </View>
          <View style={Style.AvatarContainer}>
            <View style={Style.PhotoContainer}>
              <FastImage source={Images.maleProfile} style={Style.PhotoImg} />
            </View>
            <View style={Style.nameContainer}>
              <Text>abc123</Text>
            </View>
            <View style={Style.ChatContainer}>
              <FastImage source={Images.Message1} style={Style.ChatImg} />
              <Text>3</Text>
            </View>
            <View style={Style.LikeContainer}>
              <FastImage source={Images.WhiteLike} style={Style.LikeImg} />
              <Text>9</Text>
            </View>
          </View>
        </View>
